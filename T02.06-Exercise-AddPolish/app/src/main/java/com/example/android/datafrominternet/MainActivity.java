...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mWaitingToLoadProgressBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWaitingToLoadProgressBar =(ProgressBar)findViewById(R.id.pb_loading_indicator);
    }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mWaitingToLoadProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mWaitingToLoadProgressBar.setVisibility(View.INVISIBLE);
